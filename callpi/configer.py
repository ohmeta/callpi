...
class metaconfig:
    ...
    def __init__(self, work_dir):
        ...
        self.callpi_dir = os.path.dirname(os.path.abspath(__file__))

        self.config_file = os.path.join(self.callpi_dir, "config", "config.yaml")
        self.envs_dir = os.path.join(self.callpi_dir, "envs")
        self.profiles_dir = os.path.join(self.callpi_dir, "profiles")
